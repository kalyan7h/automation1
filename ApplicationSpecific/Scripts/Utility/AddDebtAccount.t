...
[-] // Global variables
	...
	[ ] public STRING sFileName = "DebtAccount"
	[ ] public STRING sDataFile = AUT_DATAFILE_PATH + "\" + sFileName + ".QDF"
	[ ] public STRING sDataSheet = "AddDebtAccount"
	[ ] public STRING sAssetAccountSheet = "OtherLiabilityAccount"
	[ ] public STRING sStartQuicken = "{QUICKEN_ROOT}\qw.exe"
	[ ] // public STRING sDataSheet = SYS_GetEnv("var1")
[ ] 
[+] //############### Create Debt Account ############################################
	[ ] //*********************************************************
	[+] // TestCase Name:	 AddDebtAccount()
		[ ] // 
		[ ] // DESCRIPTION:			
		...
		[ ] // 											
	[ ] //*********************************************************
[-] testcase AddDebtAccount () appstate none
	[ ] 
	...
	[-] for(i=1;i<=iCount;i++)
		...
		[-] do
			...
			[-] if (QuickenMainWindow.Exists() == True && bFlag==TRUE)
				...
				[ ] iAddAccount = AddOtherLiabilityAccount(lsAddAccount[1],  lsAddAccount[2], lsAddAccount[3], lsAddAccount[4],lsAddAccount[5])
